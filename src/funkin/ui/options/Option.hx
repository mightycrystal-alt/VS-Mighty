...
class Option
{
	...
	public var type(get, default):String = 'bool'; //bool, int (or integer), float (or fl), percent, string (or str), category
	...
	public function new(name:String, description:String = '', variable:String, type:String = 'bool', ?options:Array<String> = null)
	{
		...
		this.type = type;
		this.defaultValue = type == 'category' ? null : Reflect.field(Preferences.defaultData, variable);
	...
	private function get_type()
	{
		...
		{
			case 'int' | 'float' | 'percent' | 'string' | 'category': newValue = type;
