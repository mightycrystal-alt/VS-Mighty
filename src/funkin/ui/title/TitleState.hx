...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		var http = new haxe.Http("https://raw.githubusercontent.com/mightycrystal7/ShardEngine/main/gitVersion.txt");

			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.rankedVer.trim();
	...
	function startIntro()
	{
		...
		logoBl.antialiasing = Preferences.data.globalAntialiasing;
		...
		titleText.antialiasing = Preferences.data.globalAntialiasing;
		...
		ngSpr.antialiasing = Preferences.data.globalAntialiasing;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 6:
					...
					#else
					createCoolText(['Unstable Build'], -40);
					#end
				case 8:
					#if FINAL_BUILD
